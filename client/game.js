const ur = async (insertion_element, square_size, square_unit="px", nr_tokens=7) => {
    ...
    <div id="ur-game-area">
        ...
        <div class="host" id="ur-host">
            ...
            <div class="square normal-dice"></div>
            <div class="square normal-6-dice"></div>
            <div class="square normal-dice"></div>
            ...
            <div class="square normal-7-dice"></div>
            <div class="square normal-dice"></div>
            <div class="square normal-7-dice"></div>
        </div>
    ...
    .token-blue:after  {
        ...
        content: '';
        cursor: pointer;
        background-image: url(./images/blue-token.png);
        background-size: ${square_size*1.1}${square_unit};
        background-position: center;
        width: ${square_size / 1.1}${square_unit};
        height: ${square_size / 1.1}${square_unit};
        pointer-events: none;
        display: block;
    }
    ...
    .token-red:after  {
        ...
        content: '';
        cursor: pointer;
        background-image: url(./images/red-token.png);
        background-size: ${square_size*1.1}${square_unit};
        background-position: center;
        width: ${square_size / 1.1}${square_unit};
        height: ${square_size / 1.1}${square_unit};
    ...
    const roll = async () => {
        ...
        return Promise.race([roll_promise]);
    }
